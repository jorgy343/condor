...
{
    public class MoveRegisterToRegister : Instruction

    {
        public MoveRegisterToRegister(uint position, uint functionSelect, uint dBusSelect, uint opcode, RegisterOperand registerA, RegisterOperand registerD)
